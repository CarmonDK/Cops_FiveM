...
txt = {
	...
	da = {
		police_station = "Politistation",
        	title_notification = "Staten",
       	 	now_cuffed = "Du blev smidt i håndjern",
        	now_uncuffed = "Frihed!",
        	info_fine_request_before_amount = "Tryk ~g~Y~s~ for at acceptere bøden på ",
        	info_fine_request_after_amount = " DKK, tryk ~r~R~s~ for at nægte",
        	request_fine_expired = "Bøde-anmodningen ~r~udløb~s~!",
        	pay_fine_success_before_amount = "Du betale en bøde på",
        	pay_fine_success_after_amount = " DKK",
        	help_text_open_cloackroom = "Tryk ~INPUT_CONTEXT~ for at åbne skabet",
        	help_text_put_car_into_garage = "Tryk ~INPUT_CONTEXT~ for at parkere i ~b~garagen",
        	help_text_get_car_out_garage = "Tryk ~INPUT_CONTEXT~ for at hente en bil fra ~b~garagen",
        	help_text_put_heli_into_garage = "Tryk ~INPUT_CONTEXT~ for at lande helikopteren",
        	help_text_get_heli_out_garage = "Tryk ~INPUT_CONTEXT~ for at tage en helikopter",
        	no_player_near_ped = "Ingen spiller i nærheden",
        	no_veh_near_ped = "Ingen bil i nærheden",
        
        	menu_id_card_title = "ID Kort",
        	menu_check_inventory_title = "Se inventar",
        	menu_toggle_cuff_title = "Håndjern",
        	menu_weapons_title = "Konfirsker våben",
        	menu_force_player_get_in_car_title = "Placer person i bilen",
        	menu_force_player_get_out_car_title = "Tag personen ud af bilen",
        	menu_drag_player_title = "Træk spiller",
        	menu_fines_title = "Bøder og indkaldelser",
        	menu_check_plate_title = "Kør nummerplade",
        	menu_crochet_veh_title = "Åben bil",
        	menu_global_title = "Politimenu",
        	menu_categories_title = "Kategorier",
       	 	menu_animations_title = "Animationer",
        	menu_citizens_title = "Borgere",
        	menu_vehicles_title = "Biler",
        	menu_close_menu_title = "Luk menu",
        	menu_anim_do_traffic_title = "Lav trafikstop",
        	menu_anim_take_notes_title = "Tag noter",
        	menu_anim_standby_title = "Stand By",
        	menu_anim_standby_2_title = "Stand By 2",
        	menu_anim_Cancel_emote_title = "Stop handling",
        	menu_custom_amount_fine_title = "Andet beløb",
        	menu_doing_traffic_notification = "~g~Du laver et trafikstop.",
        	menu_taking_notes_notification = "~g~Du tager noter.",
        	menu_being_stand_by_notification = "~g~Du afventer ordre.",
        	menu_veh_opened_notification = "Bilen blev ~g~åbnet~w~.",
		
		menu_put_in_jail_title = "Send i fængsel",
		menu_arrest_title = "Arrester",
		menu_custom_amount_jail_title = "Egen tid i sekunder",
		jail_notification_title = "^4[Fængsel]",
		jail_arrest_notification_part_1 = "Du blev fængslet i ^1", -- send to the client after he got put into the jail
		jail_arrest_notification_part_2 = " ^0sekunder",
		jail_weapons_removed = "Du blev fængslet og dine våben blev konfiskeret",
		jail_not_cuffed = "Spilleren skal i håndjern først.",
		jail_remove_weapons_notification_part_1 = "Alle våbene fra ",
		jail_remove_weapons_notification_part_2 = " blev fjernet.",
		menu_delete_vehicle_title = "Slet bil",
        
        	garage_global_title = "Politigarage",
        	garage_loading = "~b~Indlæser...",
        
        	cloackroom_global_title = "Politiskab",
        	cloackroom_take_service_normal_title = "Gå på arbejde som betjent",
        	cloackroom_take_service_hidden_title = "Gå på arbejde som Civil",
        	cloackroom_take_service_swat_title = "Gå på arbejde som AKS",
        	cloackroom_break_service_title = "Hold fri",
        	cloackroom_add_yellow_vest_title = "Tag refleksvest på",
        	cloackroom_remove_yellow_vest_title = "Tag refleksvest af",
        	now_in_service_notification = "Du er ~g~på arbejde",
        	break_service_notification = "Du ~r~holder fri",
        	help_open_menu_notification = "Tryk ~g~F5~w~ for at åbne ~b~politimenuen",
		
		menu_props_title = "Objekter",
		menu_spawn_props_title = "Placer objekt",
		menu_remove_last_props_title = "Fjern sidste objekt",
		menu_remove_all_props_title = "Fjern alle objekter",
        
        	vehicle_checking_plate_part_1 = "Nummerpladen ", -- before number plate
        	vehicle_checking_plate_part_2 = " tilhører ", -- between number plate and player name when veh registered
        	vehicle_checking_plate_part_3 = "", -- after player name when veh registered
        	vehicle_checking_plate_not_registered = " er ikke indregistreret", -- after player name
        	unseat_sender_notification_part_1 = "", -- before player name
        	unseat_sender_notification_part_2 = " er flygtet!", -- after player name
        	drag_sender_notification_part_1 = "Trækker ", -- before player name
        	drag_sender_notification_part_2 = "", -- after player name
        	checking_inventory_part_1 = "",
        	checking_inventory_part_2 = "'s inventar: ",
        	checking_weapons_part_1 = "",
        	checking_weapons_part_2 = "'s våben: ",
        	send_fine_request_part_1 = "Fortæl spilleren af de skal betale bøden",
        	send_fine_request_part_2 = " bødeforspørgsel sendt til ",
        	already_have_a_pendind_fine_request = " har allerede en bøde som venter",
        	request_fine_timeout = " svarede ikke på bøde-forspørgslen",
        	request_fine_refused = " afviste at betale deres bøde",
        	request_fine_accepted = " betale bøden",
        	toggle_cuff_player_part_1 = "Prøver at toggle håndjern på ",
        	toggle_cuff_player_part_2 = "",
        	force_player_get_in_vehicle_part_1 = "Tvinger ",
        	force_player_get_in_vehicle_part_2 = " ind i bilen",
        	usage_command_copadd = "Brug: /copadd [ID]",
        	usage_command_coprem = "Brug: /coprem [ID]",
        	command_received = "Forstået",
        	become_cop_success = "Velkommen til styrken!~w~",
        	remove_from_cops = "Du blev fyret.~w~.",
        	no_player_with_this_id = "Ingen spiller med dette ID.",
        	not_enough_permission = "Det bliver du vidst ikke betalt for!",
		
		armory_global_title = "Våbenskab",
		help_text_open_armory = "Tryk ~INPUT_CONTEXT~ for at åbne våbenskabet",
		armory_add_bulletproof_vest_title = "Tag skudsikker vest på.",
        	armory_remove_bulletproof_vest_title = "Tag skudsikker vest af.",
		armory_weapons_list = "Vælg våben",
		armory_basic_kit = "Basis kit",
		
		WEAPON_COMBATPISTOL = "Tjenestepistol",
		WEAPON_PISTOL50 = ".50 Pistol",
		WEAPON_PUMPSHOTGUN = "Shotgun",
		WEAPON_ASSAULTSHOTGUN = "Assault Shotgun",
		WEAPON_ASSAULTSMG = "Assault SMG",
		WEAPON_HEAVYSNIPER = "Snigskytte"
    }
}
